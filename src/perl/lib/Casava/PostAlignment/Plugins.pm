...
sub checkInitialize() {
    if (!keys %plugins)
    {
        my $CASAVA_FULL_PERL_LIBDIR = '@CASAVA_FULL_PERL_LIBDIR@'; #substituted by cmake
...
sub getPluginScriptsDir($){
    ...
    my $pluginPrivateScriptsDir = File::Spec->catfile('@CASAVA_FULL_LIBEXECDIR@', 'PostAlignment', 'Plugins', $1);
