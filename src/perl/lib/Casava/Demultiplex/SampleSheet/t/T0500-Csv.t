...
FC12345AAXX,1,sample1,human,AAGTGTC,"some, desc1",N,R1,name
FC12345AAXX,1,sample2,human,GGTCATA,'more, desc2',N,R1,name
FC12345AAXX,2,sample3,human,CCTGAAA,desc3,N,R1,name
FC12345AAXX,2,sample4,mouse,GGGAATT,desc4,N,R1,name
EOF

open my $handle, "<", \$csvData;
$sampleSheet->loadCsv($handle);

# checking the data added from the csv file
...
is ($sampleSheet->laneNumbers, 3,'Checking that there are three lanes');
is ($sampleSheet->barcodes(7), 1, 'Checking that lane 7 has 1 barcode');
